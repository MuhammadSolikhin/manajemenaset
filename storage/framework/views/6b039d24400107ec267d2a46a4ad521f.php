...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="description" name="description" rows="4"><?php echo e(old('description', $brand->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <a href="<?php echo e(route('brands.index')); ?>" class="btn btn-outline-secondary">Batal</a>
            </form>
        </div>
    </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\manajemenaset\resources\views/brands/edit.blade.php ENDPATH**/ ?>