...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" class="light-style layout-menu-fixed" dir="ltr"
    ...
    <div class="layout-container">
      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        <div class="app-brand demo">
          <a href="<?php echo e(url('/')); ?>" class="app-brand-link" style="align-items: center;">
            <img src="<?php echo e(asset('assets/img/logo.png')); ?>" alt="Logo" class="me-2" style="width: 32px; height: 32px;">
            <span class="app-brand-text demo menu-text fw-bolder" style="white-space: normal; line-height: 1.1; max-width: 160px; text-transform: none;">
              <?php echo e(ucwords(config('app.name', 'Manajemen Aset'))); ?>
        ...
        <ul class="menu-inner py-1">
          ...
          <?php if((Auth::user()->role ?? 'karyawan') === 'super_admin'): ?>
          ...
          <?php if(in_array((Auth::user()->role ?? 'karyawan'), ['admin', 'super_admin'], true)): ?>
            <li class="menu-item <?php echo e(request()->routeIs('categories.*') ? 'active' : ''); ?>">
          ...
          <?php endif; ?>
          <li class="menu-item <?php echo e(request()->routeIs('assets.*') ? 'active' : ''); ?>">
            <a href="<?php echo e(route('assets.index')); ?>" class="menu-link">
              <i class="menu-icon tf-icons bx bx-box"></i>
              <div data-i18n="Asset List">Daftar Aset</div>
            </a>
          </li>
          <?php if(in_array((Auth::user()->role ?? 'karyawan'), ['admin', 'super_admin'], true)): ?>
            <li class="menu-item <?php echo e(request()->routeIs('units.*') ? 'active' : ''); ?>">
          ...
          <?php endif; ?>
          <li class="menu-item <?php echo e((request()->routeIs('loans.*') && !request()->routeIs('loans.returned')) ? 'active' : ''); ?>">
            <a href="<?php echo e(route('loans.index')); ?>" class="menu-link">
              <i class="menu-icon tf-icons bx bx-archive"></i>
              <div data-i18n="Loans">Peminjaman</div>
            </a>
          </li>
          <li class="menu-item <?php echo e(request()->routeIs('loans.returned') ? 'active' : ''); ?>">
            <a href="<?php echo e(route('loans.returned')); ?>" class="menu-link">
              <i class="menu-icon tf-icons bx bx-history"></i>
              <div data-i18n="Returns">Riwayat Pengembalian</div>
            </a>
          </li>
          <?php if(in_array((Auth::user()->role ?? 'karyawan'), ['admin', 'super_admin'], true)): ?>
            <li class="menu-item <?php echo e(request()->routeIs('reports.*') ? 'active' : ''); ?>">
              ...
              <li class="nav-item navbar-dropdown dropdown-user dropdown">
                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                  <div class="avatar avatar-online">
                    <img src="<?php echo e(Auth::user()->profile_photo_path ? asset('storage/' . Auth::user()->profile_photo_path) : asset('assets/img/avatars/1.png')); ?>" alt class="w-px-40 h-auto rounded-circle" />
                  </div>
                </a>
                    ...
                    <a class="dropdown-item" href="<?php echo e(route('profile.edit')); ?>">
                      <div class="d-flex">
                        <div class="flex-shrink-0 me-3">
                          <div class="avatar avatar-online">
                            <img src="<?php echo e(Auth::user()->profile_photo_path ? asset('storage/' . Auth::user()->profile_photo_path) : asset('assets/img/avatars/1.png')); ?>" alt
                              class="w-px-40 h-auto rounded-circle" />
                          </div>
                        </div>
                        <div class="flex-grow-1">
                          <span class="fw-semibold d-block"><?php echo e(Auth::user()->name ?? 'User'); ?></span>
                          <small class="text-muted"><?php echo e(ucfirst(Auth::user()->role ?? 'karyawan')); ?></small>
                        </div>
                      </div>
                    </a>
                  </li>
...
</html><?php /**PATH C:\laragon\www\manajemenaset\resources\views/layouts/app.blade.php ENDPATH**/ ?>