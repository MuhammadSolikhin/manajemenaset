<table>
    ...
    <tr><td>Total Dipinjam (Unit)</td><td>{{ $borrowedUnits }}</td></tr>
    <tr><td>Total Pernah Dipinjam (Unit)</td><td>{{ $returnedUnits }}</td></tr>
...
<table>
    <tr><td colspan="4"><strong>Detail Aset Sedang Dipinjam</strong></td></tr>
    <tr><th>Aset</th><th>Peminjam</th><th>Jumlah</th><th>Tanggal Pinjam</th></tr>
...
<table>
    <tr><td colspan="5"><strong>Detail Aset Pernah Dipinjam</strong></td></tr>
    <tr><th>Aset</th><th>Peminjam</th><th>Jumlah</th><th>Tanggal Pinjam</th><th>Tanggal Kembali</th></tr>
