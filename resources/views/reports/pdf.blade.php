...
<body>
    ...
    <div class="metric">Total Dipinjam (Unit): {{ $borrowedUnits }}</div>
    <div class="metric">Total Pernah Dipinjam (Unit): {{ $returnedUnits }}</div>
    ...
    <h2>Detail Aset Sedang Dipinjam</h2>
    <table>
        <thead>
            <tr>
                <th>Aset</th>
    ...
    <h2>Detail Aset Pernah Dipinjam</h2>
    <table>
        <thead>
            <tr>
                <th>Aset</th>
