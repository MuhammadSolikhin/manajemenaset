    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('loans.store', $asset) }}" method="POST">
                ...
                <div class="mb-3">
                    <label class="form-label" for="quantity_borrowed">Jumlah yang Dipinjam</label>
                    @php
                        $totalBorrowed = \App\Models\AssetLoan::where('asset_id', $asset->id)
                            ->where('status', 'borrowed')
                            ->sum('quantity_borrowed');
                ...
                @if(isset($availableUnits) && $availableUnits->count() > 0)
                    <div class="mb-3">
                        ...
                        <div class="small text-muted mb-2">Centang unit yang ingin dipinjam. Jumlah yang dicentang harus sama dengan jumlah di atas.</div>
